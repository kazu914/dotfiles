...
################################### github cli ##############################################
#############################################################################################
zinit ice as"program" from"gh-r" mv"gh* -> gh" pick"usr/bin/gh"
zinit light cli/cli

#############################################################################################
##################################### bottom ################################################
#############################################################################################
zinit ice as"program" from"gh-r" mv"bottom* -> bottom" pick"bottom/bottom"
zinit light ClementTsang/bottom

#############################################################################################
######################################## dps ################################################
#############################################################################################
zinit ice as"program" from"gh-r" pick"dps/dps"
zinit light kazu914/dps

#############################################################################################
#################################### dmountpoint ############################################
#############################################################################################
zinit ice as"program" from"gh-r" pick"dmountpoint/dmountpoint"
